...
run "protocol-package.test.mjs (L0 @p2p/protocol)" "node protocol-package.test.mjs"
run "probe.test.mjs (L1 @p2p/probe adapters)"    "node probe.test.mjs"
...
run "observe.test.mjs (@p2p/observe plug-and-play + runtime detect)" "node observe.test.mjs"
