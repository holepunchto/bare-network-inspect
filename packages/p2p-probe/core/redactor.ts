...
import { PeerRegistry } from '../../p2p-protocol/src/registry.ts';
import type { PeerId } from '../../p2p-protocol/src/envelope.ts';
...
// peer hash goes through PeerRegistry (reuse of @p2p/protocol's 6-byte scheme); this
...
export class Redactor {
   ...
   * (local-only, for a live "show names" view). Reuses @p2p/protocol's PeerRegistry
