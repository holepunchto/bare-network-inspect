 ...
 * @holepunchto/bare-protocol's decode()). Callers who want full-fidelity decoding across
 * all four encodings should pass their own `decodeEnvelope` (e.g. one backed
 * by `decode()` from @holepunchto/bare-protocol with the app's live registries).
 *
