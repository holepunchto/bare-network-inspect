...
// (packages/bare-probe/src/sink.ts) and the L0 envelope
// (packages/bare-protocol/src/envelope.ts) so wiring is mechanical, not a
// redesign.
...
class P2PNativeProbeModule(
        ...
        object : PayloadCallback() {
            override fun onPayloadReceived(endpointId: String, payload: Payload) {
                ...
                try {
                    ...
                    // duplicating @holepunchto/bare-protocol). Emit transport-level facts;
    ...
    companion object {
        ...
        // FROZEN L2/L0 field names — must match packages/bare-probe/src/sink.ts
        // and packages/bare-protocol/src/envelope.ts byte-for-byte.
