...
//
// WHY THIS EXISTS: @holepunchto/bare-protocol's identity-drop guard (packages/bare-protocol/
 ...
 * @holepunchto/bare-protocol's `checkIdentityDrop` (identity.ts) rule set — it covers the
