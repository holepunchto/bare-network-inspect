...
// peer hash goes through PeerRegistry (reuse of @holepunchto/bare-protocol's 6-byte scheme); this
...
export class Redactor {
   ...
   * (local-only, for a live "show names" view). Reuses @holepunchto/bare-protocol's PeerRegistry
